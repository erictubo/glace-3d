...
if __name__ == '__main__':
    ...
    parser.add_argument('loss', type=str, choices=['combined', 'separate'],
                        help='loss function')
    
    parser.add_argument('contrastive_weights', type=float, nargs='+',
                        help='weights for the contrastive loss')
